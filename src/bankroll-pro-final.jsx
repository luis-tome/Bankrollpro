          ...
          {emailSent ? (
            <div style={{textAlign:"center"}}>
              ...
              <p style={{fontSize:14,color:"#6b7280",lineHeight:1.6,marginBottom:20}}>
                Enviámos um email para <strong>{authForm.email}</strong>.<br/>Clica no link para ativar a conta e começar os teus 7 dias grátis.
              </p>
              <div style={{background:"#f0fdf4",border:"1px solid #bbf7d0",borderRadius:10,padding:"12px 16px",marginBottom:20,textAlign:"left"}}>
                ...
                <div style={{fontSize:13,color:"#15803d",fontWeight:600,marginTop:4}}>✓ 7 dias grátis à tua espera</div>
              </div>
              <p style={{fontSize:12,color:"#9ca3af"}}>Não recebeste? Verifica a pasta de spam.</p>
              <button style={{...S.btnGhost,marginTop:8}} onClick={()=>{setEmailSent(false);setAuthMode("login");}}>
                Já confirmei — entrar
              </button>
            </div>
          ) : (
