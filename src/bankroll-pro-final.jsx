              ...
              <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:16}}>
                ...
                {br?.subscribed && (
                  <div style={{textAlign:"right",flexShrink:0}}>
                    ...
                    <div style={{fontSize:16,fontWeight:900,color:sc.color}}>{aiUsage}/{br?.plan==="annual"?AI_LIMIT_ANNUAL:AI_LIMIT_MONTHLY}</div>
              ...
              {!br?.subscribed && (
                <div style={{background:"#f0fdf4",border:"1px solid #bbf7d0",borderRadius:10,padding:"14px 16px",marginBottom:16}}>
                  ...
                  <div style={{display:"flex",flexDirection:"column",gap:8}}>
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",background:"#fff",border:"1px solid #bbf7d0",borderRadius:8,padding:"10px 12px"}}>
                      <div>
                        <div style={{fontSize:12,fontWeight:700,color:"#111827"}}>Plano Mensal</div>
                        <div style={{fontSize:11,color:"#6b7280"}}>{AI_LIMIT_MONTHLY} análises por mês</div>
                      </div>
                      <div style={{fontSize:13,fontWeight:900,color:"#111827"}}>€{PROMO_MONTHLY}/mês</div>
                    </div>
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",background:"#111827",borderRadius:8,padding:"10px 12px"}}>
                      <div>
                        <div style={{fontSize:12,fontWeight:700,color:"#fff"}}>Plano Anual ⭐</div>
                        <div style={{fontSize:11,color:"#9ca3af"}}>{AI_LIMIT_ANNUAL} análises por mês</div>
                      </div>
                      <div style={{fontSize:13,fontWeight:900,color:"#fff"}}>€{PROMO_ANNUAL}/ano</div>
                    </div>
                  </div>
                  <a href={STRIPE_ANNUAL} target="_blank" rel="noreferrer" style={{display:"block",background:"#15803d",color:"#fff",textDecoration:"none",padding:"11px",borderRadius:8,fontSize:13,fontWeight:700,textAlign:"center",marginTop:12}}>
                    Subscrever e desbloquear →
                  </a>
                </div>
              )}

              {br?.subscribed && aiUsage>=(br?.plan==="annual"?AI_LIMIT_ANNUAL:AI_LIMIT_MONTHLY) ? (
