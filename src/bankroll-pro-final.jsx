          ...
          <div style={{background:"#fff",borderRadius:16,padding:24,width:"100%",maxWidth:440,maxHeight:"92vh",overflowY:"auto",boxShadow:"0 20px 60px rgba(0,0,0,.2)"}}>
            ...
            {betType==="multiple" && (
              <div>
                ...
                <textarea style={{...S.input,height:80,resize:"none",fontFamily:"inherit"}} placeholder="ex: Sinner a ganhar&#10;Nadal handicap -1.5&#10;Over 22.5 games" value={form.selections||""} onChange={e=>setForm(f=>({...f,selections:e.target.value,selection:e.target.value.split("
").filter(Boolean).join(" + ")}))}/>
              </div>
            )}
