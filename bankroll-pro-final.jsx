        ...
        {tab==="diary"&&(
          <div>
            <div style={S.dateNav}>
              ...
              <div style={{flex:1,textAlign:"center",fontSize:13,fontWeight:700,color:"#111827"}}>{new Date(diaryDate+"T00:00:00").toLocaleDateString("pt-PT",{weekday:"long",day:"numeric",month:"long"}).replace(/^\w/,c=>c.toUpperCase())}</div>
              <button style={S.dateBtn} onClick={()=>{const d=new Date(diaryDate+"T00:00:00");d.setDate(d.getDate()+1);setDiaryDate(d.toISOString().slice(0,10));}}>›</button>
            </div>
